...
if __name__ == "__main__":
    ...
    parser.add_argument('--video_path', type=str, default='/hy-tmp/demo_resource/demo_video', help='video path')
    parser.add_argument('--save_dir', type=str, default='/hy-tmp/result/video_result_vit', help='save path')
    parser.add_argument('--ckpt_path', type=str, default='/hy-tmp/models/pretrained_vit/vitpose-l.pth', help='ckpt path')
