...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir_path', type=str, default='/hy-tmp/video_result_vit', help='save dir path')
    ...
    while(True):
        ...
        if flag == 1 :
            videoWrite = cv2.VideoWriter( args.save_dir_path + '/' + str(video_name) + '_result.avi', 
